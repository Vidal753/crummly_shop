# Generated by Django 4.2 on 2023-04-15 00:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(blank=True, decimal_places=2, help_text='Saldo de cliente', max_digits=10, null=True, verbose_name='Saldo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Precio mayorista')),
                ('discount', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Descuento')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Descripción')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.productcategory', verbose_name='Categoria')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('', 'Minorista'), ('2', 'Mayorista')], max_length=50, null=True, verbose_name='Tipo de Cliente')),
